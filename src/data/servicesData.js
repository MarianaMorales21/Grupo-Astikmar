export const allServices = [
  ...
  },
  {
    ...
    details: [
      'Reconstrucción de secciones completas del casco',
      'Reparación de superestructuras colisionadas',
      'Modernización de espacios a bordo (Refit)',
      'Cumplimiento con requisitos de sociedades de clasificación',
    ],
    category: 'Técnico',
    badge: 'Refit & Estructura',
    image: '/33234ac7b9097192ee286b4cb636ab33.jpg',
    iconName: 'Wrench',
    galleryTitle: 'Tipos de Reconstrucción que Realizamos',
    gallery: [
      'Reconstrucción de casco',
      'Superestructuras',
      'Refit de espacios',
